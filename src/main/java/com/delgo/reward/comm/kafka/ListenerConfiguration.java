...
//        configurations.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, KafkaProperties.KAFKA_BROKER);
//        configurations.put(ConsumerConfig.GROUP_ID_CONFIG, KafkaProperties.GROUP_ID);
