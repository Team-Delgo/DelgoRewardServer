...
public interface CommentRepository extends JpaRepository<Comment, Integer> {
    @Query(value = "select c.*, u.user_id, u.name, u.profile from comment c join user u on c.user_id = u.user_id where certification_id = ? and is_reply = false", nativeQuery = true)
